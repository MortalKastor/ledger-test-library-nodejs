...
const testAddress = ['1HE4ShfmuG7AdVr5RpaCtXfsJYYQQFCj1T'];
const testAddress1 = ['1PoBWs99bTAxDmDaUvL6yAgQ5EYyAWBdJS']
const addresses = [ '2MyEcnJgsHMdiHQrpaaknGDnqFohJo9dsMa',
...
const addresses1 =  [ '2NFAj3yaQTVKK5tXVVCHAww3Bv9BfGgD4gK',
    '2NFQ3vq37VkjGB5DHJahud8VHFWKVHLM1hU',
...
allAddresses.concat(addresses1)
//lazy loading
var binding = null;
 ...
 */
var NJSThreadDispatcherImpl = {
  contexts : []
}
var contexts = []
NJSThreadDispatcherImpl.getSerialExecutionContext = name => {

  var currentContext = contexts[name]
...
/*
    NJSItfTransactionListVmObserver Implementation
 */
var NJSTransactionListVmObserverImpl = {}
...
const LGHandle = LGApi.observer_transaction_list();

const LGObserver = new binding.NJSItfTransactionListVmObserver(NJSTransactionListVmObserverImpl);

const testnetMode = true

LGHandle.start(LGObserver, addresses, testnetMode)
//////////////////////////END TEST//////////////////////////
/*
    Test
 */
...
//
//     const LGHttp = new binding.NJSItfHttpModule(NJSHttpImpl);
//     const LGThreadDispatcher = new binding.NJSItfThreadDispatcher();
//     const LGApi = new binding.NJSItfApi(LGHttp, LGThreadDispatcher);
//     const LGObserver = new binding.NJSItfTransactionListVmObserver(LGApi);
//     LGObserver.start(addresses, testnetMode, txs => {
