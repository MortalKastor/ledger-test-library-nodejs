...
public class AndroidHttp extends Http {
    ...
    public void get(final String urlString,final ArrayList<HttpHeader> header, final HttpCallback callback) {
        mExecutor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    for(HttpHeader hr : header){
                        conn.setRequestProperty(hr.getField(), hr.getValue());
                    }
